...
Revision ID: 2890b24ef76d
Revises: 
Create Date: 2023-10-05 22:42:26.198631
...
def upgrade_():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('house_brand', sa.String(), nullable=False),
    ...
    sa.Column('us_state', sa.String(), nullable=False),
