...
# ChatGPT generated the code for me
VENDORS = ['heartysoupsinternational', 'planterson', 'lentsplysproutona', 'housebrand1', 'housebrand2']
for vendor in VENDORS:
    # ex., globals()[PlantersonUser] = type(PlantersonUser, (VendorUser,), {'__bind_key__': 'planterson'})
    # We use '''type(classname, (parentclass,), {attributes})''' to create the class,  
    # Then insert it into the global namespace accessed via globals()
